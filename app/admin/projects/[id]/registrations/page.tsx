...
export default function ProjectRegistrationsPage() {
  ...
  const exportToCSV = () => {
    ...
    a.href = url
    a.download = `${project?.title || "project"}-registrations.csv`
    a.click()
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Y4D NGO - Project Registrations</span>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {project && (
          <div className="mb-8">
            ...
            <p className="text-gray-600">Manage registrations for this project.</p>
            <div className="flex items-center space-x-4 mt-2 text-sm text-gray-500">
              <span className="bg-green-100 text-green-800 px-2 py-1 rounded">{project.category}</span>
              <span>{project.location}</span>
              <span>
                Target: {project.targetBeneficiaries} | Current: {project.currentBeneficiaries}
              </span>
            </div>
          </div>
        )}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Review and manage beneficiary applications for this project.</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">
                  {registrations.length === 0
                    ? "No beneficiaries have registered for this project yet."
